...
table$TL <- (table$cm*1.24) #add this info to summary table

table$FL <- (table$TL/1.133) #add this info to summary table

#in above line of code b=1.24 and 1.133 respctively
...
table$AvgWeight <- 0.05170*(table$FL^2.734)

#in above equation a=0.05170 and b=2.734, change out a and b values depending on species and study
