### HIPZOS for IRL ###
# hippocampus zosterae, used hippocampus erectus code
...
# used hippocampus hippocamus l-w information, and study with SL info

#Convert SL into cm and then TL used by GoM study:
table$cm <- table$AvgLength/10 #if FIM data is in cm already take this out
# table$TL <- (table$cm*1.176)+0 #add this info to summary table
...
table
table$AvgWeight <- 0.0013*(table$cm^3.187)
table
