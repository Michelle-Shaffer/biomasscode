...
table$TL <- (table$cm*1.305) #add this info to summary table

#in above line of code b=1.305
...
table$AvgWeight <- 0.01130*(table$TL^3.073)

#in above equation a=0.01130 and b=3.073, change out a and b values depending on species and study
