...
# Florida Keys, Tampa Bay FL

#Convert SL into cm and then FL used by GoM study:
table$cm <- table$AvgLength/10 #if FIM data is in cm already take this out
table$FL <- (table$cm/0.937) #add this info to summary table
#in above line of code b=1.126 and a=0
...
table$AvgWeight <- 0.05310*(table$FL^2.803)
#in above equation a=0.05310 and b=2.803, change out a and b values depending on species and study
