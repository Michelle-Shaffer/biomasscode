...
table$TL <- (table$cm*1.297) #add this info to summary table

#in above line of code b=1.297
...
table$AvgWeight <- 0.00400*(table$TL^3.790)

#in above equation a=0.00400 and b=3.790, change out a and b values depending on species and study
