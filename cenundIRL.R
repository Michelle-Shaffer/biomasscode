...
table$TL <- (table$cm*1.113) #add this info to summary table

#in above line of code b=1.113
...
table$AvgWeight <- 0.00550*(table$TL^3.037)

#in above equation a=0.00550 and b=3.037, change out a and b values depending on species and study
